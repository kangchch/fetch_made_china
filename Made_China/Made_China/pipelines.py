...
class MadeChinaPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            # spider.mongo_db.content_tbl_test.insert_one(i)
            spider.mongo_db.made_china_tbl.update_one({'company_url': i['company_url']}, {'$set': {'status': 1}})
